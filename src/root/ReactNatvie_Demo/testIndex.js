...
import CustomTabs from './js/CustomTabs';
import Drawer from './js/Drawer';
import TabsInDrawer from './js/TabsInDrawer';
import ModalStack from './js/ModalStack';
import StacksInTabs from './js/StacksInTabs';
import StacksOverTabs from './js/StacksOverTabs';
import SimpleStack from './js/SimpleStack';
import SimpleTabs from './js/SimpleTabs';
